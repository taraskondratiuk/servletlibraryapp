            ...
            <nav class="navigation">
                ...
                <div class="row menu_row">
                    ...
                    <div class="col-lg-offset-6 col-lg-2 menu-item center-text">
                        <a class="nav-link" href="${pageContext.request.contextPath}/reader/books">books<h3 class="translate" data-args="message.mainpage"></h3></a>
                    </div>
        ...
        <div class="takes-filter col-lg-4 mgtop-container">
            <div class="form-horizontal filter-form col-lg-12">
                <fieldset>
                    ...
                    <form action="${pageContext.request.contextPath}/reader/takes" method="get">
            ...
            <div id="takes" class="row">
                ...
                col-lg-16">
                        ...
                        <div class="col-lg-10 take-info">
                            ...
                            <c:if test="${!b.isReturned}">
                                <form action="${pageContext.request.contextPath}/reader/returnBook" method="post">


                                <input type="hidden" name="takeId" value="${b.id}">
                                <button type="submit" class="return-book" data-id="{{id}}">return</button>
                                </form>
                            </c:if>
